...
public:
   BulletStrategy(double angle = 0.0, double speed = 30.0, double radius = 5.0, int value = 1);
   ...
   // special functions
   virtual void death(std::list<BulletStrategy *> & bullets) {}
 ...
 * Small little bullet
 **********************/
class Pellet : public BulletStrategy
{
public:
   Pellet(double angle, double speed = 15.0) : BulletStrategy(angle, speed, 1.0, 1) {}
 ...
 * Things that go "boom"
 **********************/
class Bomb : public BulletStrategy
{
private:
   int timeToDie;
public:
   Bomb(double angle, double speed = 10.0) : BulletStrategy(angle, speed, 4.0, 4), timeToDie(60) {}
   
   void output();
   void move(std::list<Effect*> & effects);
   void death(std::list<BulletStrategy *> & BulletStrategys);
};
 ...
 **********************/
class Shrapnel : public BulletStrategy
{
private:
   int timeToDie;
public:
 ...
 * Guided missiles
 **********************/
class Missile : public BulletStrategy
{
public:
   Missile(double angle, double speed = 10.0) : BulletStrategy(angle, speed, 1.0, 3) {}
